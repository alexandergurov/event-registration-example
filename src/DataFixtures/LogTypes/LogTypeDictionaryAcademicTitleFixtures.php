...
class LogTypeDictionaryAcademicTitleFixtures extends Fixture
{

    public function load(ObjectManager $manager): void
    {
        $logTypeDictionaryCreate = new LogType();
        $logTypeDictionaryCreate->setTitle('Добавление записи в справочник "Ученое звание"');
        $logTypeDictionaryCreate->setDescription('Добавление записи в справочник "Ученое звание"');
        ...
        $logTypeDictionaryCreate->setLogObject($this->getReference(LogTypePropertiesFixtures::LOG_OBJECT_DICTIONARY_ACADEMIC_TITLE_REFERENCE));
        ...
        $logTypeDictionaryCreateFail->setTitle('Ошибка добавления записи в справочник "Ученое звание"');
        $logTypeDictionaryCreateFail->setDescription('Ошибка добавления записи в справочник "Ученое звание"');
        ...
        $logTypeDictionaryCreateFail->setLogObject($this->getReference(LogTypePropertiesFixtures::LOG_OBJECT_DICTIONARY_ACADEMIC_TITLE_REFERENCE));
        ...
        $logTypeDictionaryUpdate->setTitle('Редактирование записи в справочнике "Ученое звание"');
        $logTypeDictionaryUpdate->setDescription('Редактирование записи в справочнике "Ученое звание"');
        ...
        $logTypeDictionaryUpdate->setLogObject($this->getReference(LogTypePropertiesFixtures::LOG_OBJECT_DICTIONARY_ACADEMIC_TITLE_REFERENCE));
        ...
        $logTypeDictionaryUpdateFail->setTitle('Ошибка редактирования в справочнике "Ученое звание"');
        $logTypeDictionaryUpdateFail->setDescription('Ошибка редактирования в справочнике "Ученое звание"');
        ...
        $logTypeDictionaryUpdateFail->setLogObject($this->getReference(LogTypePropertiesFixtures::LOG_OBJECT_DICTIONARY_ACADEMIC_TITLE_REFERENCE));
        ...
        $logTypeDictionaryDelete->setTitle('Удаление записи из справочника "Ученое звание"');
        $logTypeDictionaryDelete->setDescription('Удаление записи из справочника "Ученое звание"');
        ...
        $logTypeDictionaryDelete->setLogObject($this->getReference(LogTypePropertiesFixtures::LOG_OBJECT_DICTIONARY_ACADEMIC_TITLE_REFERENCE));
        ...
        $logTypeDictionaryDeleteFail->setTitle('Ошибка удаления записи из справочника "Ученое звание"');
        $logTypeDictionaryDeleteFail->setDescription('Ошибка удаления записи из справочника "Ученое звание"');
        ...
        $logTypeDictionaryDeleteFail->setLogObject($this->getReference(LogTypePropertiesFixtures::LOG_OBJECT_DICTIONARY_ACADEMIC_TITLE_REFERENCE));
